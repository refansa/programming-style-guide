...
This style guide is a fork of, and heavily inspired by [Uber Go Style Guide](https://github.com/uber-go/guide). 
Customized and tailored to the need, and style of our project.
